...
string Utiles::int_to_bin(int number) {
...
string Utiles::reverse(string to_reverse) {
	string result;
...
string Utiles::to_hex(int to_convert) {
	string result;
	stringstream ss;
	ss << hex << to_convert;
	ss >> result;
...
string Utiles::to_bin(int to_convert) {
	return int_to_bin(to_convert);
}

int Utiles::hex_to_int(string to_int) {
...
string Utiles::bin_complement(string number) {
...
int Utiles::to_int(string to_integer) {
	int resultat = 0;
...
string Utiles::hex_to_bin(const string &hexaString) {
	stringstream ss;
	ss << hex << hexaString;
	unsigned n;
	ss >> n;
...
string Utiles::bin_to_hex(const string &binaryString) {
